...
<a href="<?php echo REL; ?>_code/admin/ventes.php" class="button vente edit venSH" title="Gérer les ventes">Ventes</a> <a href="<?php echo REL; ?>_code/admin/articles.php" class="button articles edit artSH" title="Gérer les articles">Articles</a> <a href="<?php echo REL; ?>_code/admin/caisse.php" id="caisseOpener" target="caisseWindow" class="button caisse edit caiSH" title="Caisse (ouverture et fermeture)">Caisse</a> <a href="<?php echo REL; ?>_code/admin/caisses-au-mois.php" class="button caiSH" title="voir les caisses du mois">Caisse/mois</a> <a href="<?php echo REL; ?>_code/admin/manage_categories.php?table=categories" class="button edit catSH" title="gérer les catégories">Catégories</a> <a href="<?php echo REL; ?>_code/admin/manage_categories.php?table=matieres" class="button edit catSH" title="gérer les matières">Matières</a> 
...
a.onclick = function(e){
	...
	if(!caisseWindow || caisseWindow.closed){
		caisseWindow = window.open(rel+"_code/admin/caisse.php","caisseWindow", '', false);
	}else{
