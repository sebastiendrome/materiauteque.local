...
<!-- generic css -->
<link href="<?php echo REL; ?>c/css/common.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css">


<!-- load responsive design style sheets -->
<link rel="stylesheet" media="(max-width: 980px)" href="<?php echo REL; ?>c/css/max-980px.css?v=<?php echo $version; ?>">
<link rel="stylesheet" media="(max-width: 720px)" href="<?php echo REL; ?>c/css/max-720px.css?v=<?php echo $version; ?>">
