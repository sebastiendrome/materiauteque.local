...
<!-- jQuery -->
<script type="text/javascript" src="<?php echo REL; ?>c/js/jquery-3.2.1.min.js" charset="utf-8"></script>
<!-- table sorter -->
<script type="text/javascript" src="<?php echo REL; ?>c/js/jquery.tablesorter.min.js" charset="utf-8"></script>
<!-- common custom js -->
<script type="text/javascript" src="<?php echo REL; ?>c/js/js.js?v=<?php echo $version; ?>" charset="utf-8"></script>
<!-- js for admin -->
<script type="text/javascript" src="<?php echo REL; ?>c/js/admin_js.js?v=<?php echo $version; ?>" charset="utf-8"></script>
