...
if($previous_statut_id == name_to_id('vendu', 'statut') ){
	echo '<form name="prixDeVente" id="prixDeVente" action="'.REL.'c/php/admin/admin_ajax.php" method="post" style="margin:0 !important;">
	...
	?>
	<form name="prixDeVente" id="prixDeVente" action="<?php echo REL; ?>c/php/admin/admin_ajax.php" method="post">
	<?php 
